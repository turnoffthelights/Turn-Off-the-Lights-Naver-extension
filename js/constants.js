...
if(window.location.href.match(/^http(s)?:\/\/(www\.)?stefanvd.net/i) || window.location.href.match(/^http(s)?:\/\/(www\.)?turnoffthelights.com/i)){
	if($("turnoffthelights-naver-install-button")){
		$("turnoffthelights-naver-install-button").style.display = "none";
		$("turnoffthelights-naver-thanks-button").style.display = "block";
	}
}
...
const linkchangelog = "https://www.turnoffthelights.com/extension/naverchangelog.html";
...
const linkwelcomepage = "https://www.turnoffthelights.com/extension/naverwelcome.html";
const linkuninstall = "https://www.turnoffthelights.com/extension/naveruninstalled.html";
const linkguide = "https://www.turnoffthelights.com/extension/naverguide.html";
